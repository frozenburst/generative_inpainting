...
parser.add_argument('--folder_path', default='/work/r08922a13/Waveform-auto-encoder/datasets/ESC-50-master/spectrogram_15seg', type=str,
                    help='The folder path')
parser.add_argument('--train_filename', default='./data/esc50/spec_15seg/train_shuffled.flist', type=str,
                    help='The train filename.')
parser.add_argument('--validation_filename', default='./data/esc50/spec_15seg/validation_static_view.flist', type=str,
